...
const weatherData2 = [
  //This is not being used and  an delete
  {
    _id: "5d94b8efd07b4c00043dbae7",
    Sol: 295,
    av: -69.706,
        ...
        <div className="chartWrapper">
          ...
          <VictoryChart domainPadding={3} theme={VictoryTheme.material}>
            ...
            <VictoryLegend
              ...
              style={
                //this "styles" specifically works on the styling for the legend
                {
                  border: {
                    //"border" adds a border box around the entire legend
                    stroke: "black"
                  },
              ...
              s
              data={
                //this this specifically adjusts the data points and interacts with them
                [
                  { name: "Max", symbol: { fill: "#fc0f03", type: "star" } }, //this interacts with the first data point
                  {
                    name: "Average",
                    symbol: { fill: "#24fc03", type: "star" }
                  }, //this interacts with the second data point
            ...
            <VictoryAxis dependentAxis={true} tickFormat={x => `${x / 1}°F`} />
            {/* Data point 1 - average tempature */}
            <VictoryLine
              animate={{
                //this is how you animate
                duration: 2000,
